...
import { Home, User, Briefcase, FileText, Phone, Zap } from 'lucide-react';
...
export const ArtificialHero = () => {
  ...
  // NavItems not used by LiquidNavbar but kept for reference if needed
  const navItems = [
    { name: 'Home', url: '/', icon: Home },
    { name: 'About', url: '#about', icon: User },
    { name: 'Services', url: '#services', icon: Zap },
    { name: 'Portfolio', url: '#projects', icon: Briefcase },
  ...
  return (
    <div ref={containerRef} className="artificial-hero-container" style={{ width: '100%', height: '100vh', background: '#000', position: 'relative' }}>
      {/* Tubelight Navbar */}
      ...
      <div className="hero-title-container">
        <div className="hero-title">
          <span className="hero-word-primary">DARSHAN</span>
      ...
      <div className="hero-info-right">
        <div className="hero-info-text" style={{ textAlign: 'right' }}>
          Building<br/>
          Digital<br/>
          Experiences
        </div>
      ...
      <div className="hero-footer">
        <div className="hero-footer-text">
          Portfolio &copy; {new Date().getFullYear()} @darshndev
        </div>
      </div>
